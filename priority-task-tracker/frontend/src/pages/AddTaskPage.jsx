        ...
        <div className='p-2 border-2 border-black bg-white rounded-lg shadow-md m-4 w-11/12 relative'>
          <form onSubmit={submitForm}>
            ...
            <div className='flex justify-center pt-4 mb-4'>
              <button
                className='bg-green-200 hover:bg-green-300 hover:text-black font-bold py-2 rounded-md w-11/12 focus:outline-none focus:shadow-outline' type='submit'>Add Task</button>
            </div>
          </form>
        </div>
      </div>
